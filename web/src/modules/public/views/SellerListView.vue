<template>
  <div class="w-100">
    ...
    <banner-overlay :imgSrc="require('../../../assets/banner-seller.svg')"
    ...
    <b-container fluid class="mt-4 mb-4">
      <section>
        ...
        <b-row class="mt-2">
          <b-col cols="12" sm="4" md="4" lg="4" class="mt-2 mb-2 h-100" v-for="seller in sellers" :key="seller.id">
            <b-card no-body class="custom-card w-100 shadow">
              <b-card-img :src="seller.mainImage" class="custom-img" role="button"
      ...
      <div class="d-flex align-items-center justify-content-center my-2">
        <b-pagination v-model="pagination.page" :total-rows="totalRows" :per-page="pagination.size" size="sm" pills
...
export default {
  ...
  components: {
    ...
    CustomOverlay: () => import("@/modules/public/components/CustomOverlay.vue"),
  },
...
.custom-img {
  object-fit: cover;
  /* Hace que la imagen se adapte sin distorsionarse */
  height: 200px;
  /* Define una altura fija para mantener la consistencia */
  width: 100%;
